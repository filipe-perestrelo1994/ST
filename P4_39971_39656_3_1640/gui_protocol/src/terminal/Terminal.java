...
public class Terminal extends javax.swing.JFrame implements Log, Simulator {
    ...
    public Terminal() {
        ...
        ack_timer_on = false;
        timer_on = new HashMap<Integer, Long>();
        transmitted_data= new HashMap<String, Integer>();
        sending_data= false;
    }
    ...
    private void initComponents() {
        ...
        jTextPackets = new javax.swing.JTextField();
        ...
        setTitle("Protocol by 11111, 22222 and 33333");
        ...
        jLabel7.setText("Packets");
        jPanel3.add(jLabel7);

        jTextPackets.setText("2");
        jTextPackets.setMaximumSize(new java.awt.Dimension(70, 27));
        jTextPackets.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextPacketsActionPerformed(evt);
            }
        });
        jPanel3.add(jTextPackets);

        jLabel8.setText("Timeout");
        jPanel3.add(jLabel8);

        jTextTimeout.setText("22");
    ...
    private void editable_textBoxes(boolean editable) {
        ...
        jTextPackets.setEditable(editable);
    ...
    public int get_packets() {
        try {
            return Integer.parseInt(jTextPackets.getText());
        } catch (Exception e) {
            Log("Invalid number fo packets: " + jTextPackets.getText() + ".\n Using 10\n");
            return 1;
        }
    }
    ...
    private void jTextPacketsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextPacketsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextPacketsActionPerformed
    ...
    /**
     * Start a timer for delay, associated to packet "key"
     *
    ...
    public void start_data_timer(int key) {
        try {
            ...
            Log("Error in start_data_timer: " + ex + "\n");
        }
    }

    /**
     * Cancel the timer associated with packet "key"
     *
     * @param key
     */
    @Override
    public void cancel_data_timer(int key) {
        try {
            Event ev = Event.new_Start_Timer(this, time, key, -1);
            if (key >= 0) {
                ...
                Log(time + " INVALID cancel_data_timer: key must be >= 0\n");
            }
        } catch (Exception ex) {
            Log("Error in cancel_data_timer: " + ex + "\n");
        }
    }
    ...
    public void start_ack_timer() {
        try {
            Event ev = Event.new_Start_Timer(this, time, -1, ACK_TIMEOUT);
    ...
    public void cancel_ack_timer() {
        if (ack_timer_on) {
            ack_timer_on = false;
            try {
                Event ev = Event.new_Start_Timer(this, time, -1, -1);
     ...
     */
    private HashMap<String,Integer> transmitted_data;
    ...
    private javax.swing.JTextField jTextPackets;
