...
public class Event {
    ...
    public String toString() {
        ...
        } else if (kind == START_TIMER) {
            str += " " + interval + " " + key;
        } else if (kind == TIMER_EVENT) {
            str += " " + key;
        } else if (kind == DATA_END) {
            str += " " + key;
        } else if (kind == STAT_EVENT) {
            switch (key) {
    ...
    public boolean str_to_event(String line, Log log) {
        ...
        try {
            ...
            if (cmd.equals("TIME")) {
                ...
                kind= FRAME_EVENT;
            } else if (cmd.equals("START_TIMER")) {
                if (st.countTokens() != 2) {
                ...
                kind= START_TIMER;
            } else if (cmd.equals("TIMER_EVENT")) {
                if (st.countTokens() != 1) {
